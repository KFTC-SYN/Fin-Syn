...
def suggest_mlp_params(trial):
    ...
    params["lr"] = trial.suggest_loguniform("lr", 0.001, 0.01)
    ...
    # min_n_layers, max_n_layers, d_min, d_max 
    params["d_layers"] = _suggest_mlp_layers(trial, [1, 4, 4, 8])
...
def suggest_catboost_params(trial):
    ...
    params = params | {
        ...
        "od_pval": 0.001,   # 0.001
        "task_type": "GPU", # "GPU", may affect performance
        "thread_count": 4,
        "devices": "0", # for GPU
    }
...
def objective(trial):
    if args.model == "mlp":
        ...
        T_dict = {
            ...
            # "cat_min_frequency": 0.01,  # 2025.11.22 드문 카테고리를 통합하여 메모리 사용량 감소
