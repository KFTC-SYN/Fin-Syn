...
class CTABGAN():
    ...
    def __init__(self,
        ...
        self.synthesizer = CTABGANSynthesizer(lr = lr, epochs = epochs, batch_size = batch_size, class_dim = class_dim, random_dim = random_dim, num_channels = num_channels, device = device)
        self.raw_df = df
