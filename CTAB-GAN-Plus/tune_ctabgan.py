...
def objective(trial):
    ...
    # 2025.11.29
    min_n_layers, max_n_layers, d_min, d_max = 1, 4, 4, 6  # class_dim을 16-64로 축소
    ...
    # 2025.11.29
    batch_size = 2 ** trial.suggest_int('batch_size', 9, 11)  # 유지
    random_dim = 2 ** trial.suggest_int('random_dim', 4, 5)  # 16, 32 축소
    num_channels = 2 ** trial.suggest_int('num_channels', 3, 4)  # 8, 16 축소
